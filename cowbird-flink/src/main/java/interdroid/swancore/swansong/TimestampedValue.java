...
public class TimestampedValue implements Serializable, //Parcelable,
	...
	public static Object applyModeForRemoteEvaluation(final List<TimestampedValue> values, HistoryReductionMode mode) {
			switch (mode) {
				case MAX:
					return TimestampedValue
							.findMaxValue(values).mValue;
				case MIN:
					return TimestampedValue
							.findMinValue(values).mValue;
				case MEAN:
					return TimestampedValue
							.calculateMean(values).mValue;
				case MEDIAN:
					return TimestampedValue
							.calculateMedian(values).mValue;
				case ALL:
				case ANY:
				default:
					return null;
